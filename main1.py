...
arcade.draw_ellipse_filled(370,320,30,50,open_color.black)
arcade.draw_ellipse_filled(430,320,30,50,open_color.black)
arcade.draw_circle_filled(375,330,3,open_color.gray_2)
arcade.draw_circle_filled(435,330,3,open_color.gray_2)

#(x,y,width,height,color,start_degrees,end_degrees,border_thickness)
arcade.draw_arc_outline(400,275,60,50,open_color.black,190,350,4)
